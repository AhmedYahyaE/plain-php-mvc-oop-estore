<nav class="main_navigation <?= (isset($_COOKIE['menu_opened']) && $_COOKIE['menu_opened'] == 'true') ? 'opened no_animation' : '' ?>">
    <div class="employee_info">
        ...
        <span class="name"><?php // echo $this->session->u->profile->FirstName ?> <?php // echo $this->session->u->profile->LastName ?></span>
        <span class="privilege"><?php echo $this->session->u->GroupName ?></span>
    </div>
